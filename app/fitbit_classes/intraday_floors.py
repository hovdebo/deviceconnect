...
class IntradayFloors:
    def __init__(self, json_dict):
        self.date = None

        activities = json_dict["activities-floors"]
        if len(activities) > 1:
        ...
        activities_intraday = json_dict["activities-floors-intraday"]
        ...
        self.activities_df.rename(columns={"value": "floors"}, inplace=True)
