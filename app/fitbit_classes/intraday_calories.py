...
class IntradayCalories:
    def __init__(self, json_dict):
        ...
        activities = json_dict["activities-calories"]
        if len(activities) > 1:
        ...
        activities_intraday = json_dict["activities-calories-intraday"]
        ...
        self.activities_df.rename(columns={"value": "calories"}, inplace=True)
